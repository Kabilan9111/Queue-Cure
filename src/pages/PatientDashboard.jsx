...
import { 
  ...
  Activity, Sparkles, ArrowRight, Star, Upload, Stethoscope, FlaskConical, Workflow
} from 'lucide-react';
...
export default function PatientDashboard() {
  ...
  const navLinks = [
    ...
    { name: 'Medicine Status', icon: Pill },
        ...
        <main className="flex-1 overflow-y-auto p-6 lg:p-10 pt-4 no-scrollbar">
          ...
          >
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
              ...
              {/* QUEUE STATUS (Span 4) */}
              <motion.div variants={itemVariants} className="xl:col-span-4 h-auto xl:h-[260px] bg-white rounded-[24px] p-8 border border-[#EEF2FF] shadow-[0_8px_30px_rgba(0,0,0,0.04)] flex flex-col justify-between">
                ...
                <div className="flex items-center justify-between mb-6 bg-[#FAFBFF] rounded-[16px] p-4 border border-[#EEF2FF]">
                  ...
                  <div className="text-center">
                    <p className="text-[10px] text-slate-400 font-semibold mb-1">Estimated Wait Time</p>
                    <p className="text-[16px] font-bold text-slate-800 flex items-center justify-center gap-1.5"><Clock className="w-3.5 h-3.5 text-slate-400"/> 12 mins</p>
                  </div>
                  <div className="w-px h-10 bg-slate-200"></div>
                  <div className="text-center">
                    <p className="text-[10px] text-slate-400 font-semibold mb-1">People Ahead</p>
                ...
                <div>
                  ...
                  <p className="text-[10px] text-emerald-600 font-semibold">You will be attended soon. Please relax.</p>
                </div>
              </motion.div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
              ...
              <motion.div variants={itemVariants} className="xl:col-span-7 bg-white rounded-[24px] p-8 border border-[#EEF2FF] shadow-[0_8px_30px_rgba(0,0,0,0.04)]">
                <div className="flex items-center justify-between mb-10">
                  ...
                  <button className="text-[11px] font-bold text-[#6C63FF] flex items-center gap-1.5 hover:underline">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-left border-collapse">
                    ...
                    <tbody className="text-[12px] font-medium text-slate-600">
                      <tr className="border-b border-slate-50 hover:bg-[#FAFBFF] transition-colors">
                        <td className="py-4 pl-2 text-slate-500">28 June 2026, 11:00 AM</td>
                        <td className="py-4 text-slate-800 font-bold">Dr. Priya Sharma</td>
                        <td className="py-4">Dermatology</td>
                        <td className="py-4">Follow-up</td>
                        <td className="py-4"><span className="text-[10px] font-bold text-emerald-600 bg-emerald-50 border border-emerald-100 px-2.5 py-1 rounded-md">Confirmed</span></td>
                      </tr>
                      <tr className="border-b border-slate-50 hover:bg-[#FAFBFF] transition-colors">
                        <td className="py-4 pl-2 text-slate-500">10 July 2026, 09:30 AM</td>
                        <td className="py-4 text-slate-800 font-bold">Dr. Amit Verma</td>
                        <td className="py-4">General Physician</td>
                        <td className="py-4">Consultation</td>
                        <td className="py-4"><span className="text-[10px] font-bold text-emerald-600 bg-emerald-50 border border-emerald-100 px-2.5 py-1 rounded-md">Confirmed</span></td>
                      </tr>
                      <tr className="hover:bg-[#FAFBFF] transition-colors">
                        <td className="py-4 pl-2 text-slate-500">22 July 2026, 02:00 PM</td>
                        <td className="py-4 text-slate-800 font-bold">Dr. Neha Gupta</td>
                        <td className="py-4">Nutrition</td>
                        <td className="py-4">Consultation</td>
                        <td className="py-4"><span className="text-[10px] font-bold text-orange-600 bg-orange-50 border border-orange-100 px-2.5 py-1 rounded-md">Pending</span></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                <button className="w-full mt-2 text-[11px] font-bold text-[#6C63FF] hover:text-[#4F8CFF] transition-colors flex items-center justify-center gap-1.5 pt-5 border-t border-[#EEF2FF]">
